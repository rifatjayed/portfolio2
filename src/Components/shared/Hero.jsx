...
const Hero = () => {
  return (
    <div className="">
      <div className=" ">
        <h1 className=" bg-gradient-to-r from-[#595A7B] via-[#FFF] to-[#595A7B] bg-clip-text text-transparent text-center font-neue-regrade text-[350px] font-bold leading-none">
          DESIGN
        </h1>
